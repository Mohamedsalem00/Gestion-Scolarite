            ...
            @foreach ($AF1 as $item)
                <tr>
                    ...
                    <td>
                            ...
                            @endforeach
                            @if (!$noteExists)
                                <a class="note-link" id="allAction" href="{{ route('note.create', ['id' => $item->id_etudiant,'type'=>'devoir1', 'matiere' =>'Calcule']) }}">Ajouter une note</a>
                            @endif
                    ...
                    <td>
                            ...
                            @endforeach
                            @if (!$noteExists)
                                <a class="note-link" id="allAction" href="{{ route('note.create', ['id' => $item->id_etudiant,'type'=>'devoir1', 'matiere' => 'التربية الإسلامية']) }}">Ajouter une note</a>
                            @endif
                    ...
                    <td>
                            ...
                            @endforeach
                            @if (!$noteExists)
                               <a class="note-link" id="allAction" href="{{ route('note.create', ['id' => $item->id_etudiant,'type'=>'devoir1', 'matiere' => 'اللغة العربية']) }}">Ajouter une note</a>
                            @endif
            ...
            @foreach ($AF2 as $item)
                <tr>
                    ...
                    <td>
                            ...
                            @endforeach
                            @if (!$noteExists)
                               <a class="note-link" id="allAction" href="{{ route('note.create', ['id' => $item->id_etudiant,'type'=>'devoir1', 'matiere' => 'Sciences naturelles']) }}">Ajouter une note</a>
                            @endif
                    ...
                    <td>
                            ...
                            @endforeach
                            @if (!$noteExists)
                               <a class="note-link" id="allAction" href="{{ route('note.create', ['id' => $item->id_etudiant,'type'=>'devoir1', 'matiere' => 'Français']) }}">Ajouter une note</a>
                    ...
                    <td>
                            ...
                            @endforeach
                            @if (!$noteExists)
                               <a class="note-link" id="allAction" href="{{ route('note.create', ['id' => $item->id_etudiant,'type'=>'devoir1', 'matiere' => 'التربية المدنية']) }}">Ajouter une note</a>
                            @endif
                    ...
                    <td>
                            ...
                            @endforeach
                            @if (!$noteExists)
                               <a class="note-link" id="allAction" href="{{ route('note.create', ['id' => $item->id_etudiant,'type'=>'devoir1', 'matiere' => 'التاريخ و الجغرافيا']) }}">Ajouter une note</a>
                            @endif
                    </td>
                </tr>
            @endforeach`,
            ...
            @foreach ($AF6 as $item)
                <tr>
                    ...
                    <td>
                            ...
                            @endforeach
                            @if (!$noteExists)
                                <a class="note-link" id="allAction" href="{{ route('note.create', ['id' => $item->id_etudiant,'type'=>'devoir1', 'matiere' =>'Mathématiques']) }}">Ajouter une note</a>
                            @endif
            ...
            @foreach ($AS1 as $item)
                <tr>
                    ...
                    <td>
                            ...
                            @endforeach
                            @if (!$noteExists)
                               <a class="note-link" id="allAction" href="{{ route('note.create', ['id' => $item->id_etudiant,'type'=>'devoir1', 'matiere' => 'Anglais']) }}">Ajouter une note</a>
            ...
            @foreach ($AS3 as $item)
                <tr>
                    ...
                    <td>
                            ...
                            @endforeach
                            @if (!$noteExists)
                               <a class="note-link" id="allAction" href="{{ route('note.create', ['id' => $item->id_etudiant,'type'=>'devoir1', 'matiere' => 'Physique Chimie']) }}">Ajouter une note</a>
                            @endif
