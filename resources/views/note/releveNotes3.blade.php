    ...
    <div class="container mt-5">
        <div style="display: flex;" class="mb-5">
            <div style="width: 15%; font-size: 1.5rem" id="allAction">
                <a href="javascript:history.back()" title="retourne" id="allAction"><i class="bi bi-arrow-left"></i></a>
            </div>
            <div>
                <h1 class="text-center">Releve de notes du troisième trimestre</h1>
            </div>
        </div>
        ...
        const timetableData = {
            ...
            @foreach ($AF1 as $item)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('spectacleT3',['id' => $item->id_etudiant,'trimestre' => 'Troisième trimestre']) }}" >
