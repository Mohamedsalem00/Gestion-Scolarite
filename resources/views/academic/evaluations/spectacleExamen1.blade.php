        ...
        <div class="container">
            <div class="row align-items-center" id="allAction">
                ...
                <div class="col-md-5 text-md-start text-center">
                    <p class="mb-0"> Debut: <strong> 2023-10-23 </strong>  |  Fine: <strong> 2023-10-27 </strong></p>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <h1 class="text-center mt-4">Emploi du temps de l'examen (1)</h1>
                </div>
            </div>
        </div>
    </header>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped">
                    <thead>
                        ...
                        <script>
                            var DebutDevoir1 = new Date('2023-10-23');
                            var FineDevoir1 = new Date('2023-10-27');
