...
@section('content2')
    <div class="container mt-5">
        <div style="display: flex;" class="mb-5">
            ...
            <div>
                <h1 class="text-center">Résultats du troisième devoire</h1>
            </div>
        </div>
            ...
            @foreach ($AF1 as $item)
                <tr>
                    ...
                    <td>
                            ...
                            @endforeach
                            @if (!$noteExists)
                                <a class="note-link" id="allAction" href="{{ route('notes.create', ['id' => $item->id_etudiant,'type'=>'devoir3', 'matiere' =>'Calcule']) }}">Ajouter une note</a>
                            @endif
                    ...
                    <td>
                            ...
                            @endforeach
                            @if (!$noteExists)
                                <a class="note-link" id="allAction" href="{{ route('notes.create', ['id' => $item->id_etudiant,'type'=>'devoir3', 'matiere' => 'التربية الإسلامية']) }}">Ajouter une note</a>
                            @endif
                    </td>
                    <td>
                            @php
                            ...
                            @endforeach
                            @if (!$noteExists)
                               <a class="note-link" id="allAction" href="{{ route('notes.create', ['id' => $item->id_etudiant,'type'=>'devoir3', 'matiere' => 'اللغة العربية']) }}">Ajouter une note</a>
                            @endif
            ...
            @foreach ($AF2 as $item)
                <tr>
                    ...
                    <td>
                            ...
                            @endforeach
                            @if (!$noteExists)
                               <a class="note-link" id="allAction" href="{{ route('notes.create', ['id' => $item->id_etudiant,'type'=>'devoir3', 'matiere' => 'Sciences naturelles']) }}">Ajouter une note</a>
                            @endif
                    ...
                    <td>
                            ...
                            @endforeach
                            @if (!$noteExists)
                               <a class="note-link" id="allAction" href="{{ route('notes.create', ['id' => $item->id_etudiant,'type'=>'devoir3', 'matiere' => 'Français']) }}">Ajouter une note</a>
                    ...
                    <td>
                            ...
                            @endforeach
                            @if (!$noteExists)
                               <a class="note-link" id="allAction" href="{{ route('notes.create', ['id' => $item->id_etudiant,'type'=>'devoir3', 'matiere' => 'التربية المدنية']) }}">Ajouter une note</a>
                            @endif
                    ...
                    <td>
                            ...
                            @endforeach
                            @if (!$noteExists)
                               <a class="note-link" id="allAction" href="{{ route('notes.create', ['id' => $item->id_etudiant,'type'=>'devoir3', 'matiere' => 'التاريخ و الجغرافيا']) }}">Ajouter une note</a>
                            @endif
                    </td>
                </tr>
            @endforeach`,
            ...
            @foreach ($AF6 as $item)
                <tr>
                    ...
                    <td>
                            ...
                            @endforeach
                            @if (!$noteExists)
                                <a class="note-link" id="allAction" href="{{ route('notes.create', ['id' => $item->id_etudiant,'type'=>'devoir3', 'matiere' =>'Mathématiques']) }}">Ajouter une note</a>
                            @endif
            ...
            @foreach ($AS1 as $item)
                <tr>
                    ...
                    <td>
                            ...
                            @endforeach
                            @if (!$noteExists)
                               <a class="note-link" id="allAction" href="{{ route('notes.create', ['id' => $item->id_etudiant,'type'=>'devoir3', 'matiere' => 'Anglais']) }}">Ajouter une note</a>
            ...
            @foreach ($AS3 as $item)
                <tr>
                    ...
                    <td>
                            ...
                            @endforeach
                            @if (!$noteExists)
                               <a class="note-link" id="allAction" href="{{ route('notes.create', ['id' => $item->id_etudiant,'type'=>'devoir3', 'matiere' => 'Physique Chimie']) }}">Ajouter une note</a>
                            @endif
