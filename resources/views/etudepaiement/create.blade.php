...
@section('title', 'Créer un paiement de salaire')
@section('content2')
    <style>
        .montant-section {
            display: flex;
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="montant-section" style="width: 100%;">
                        ...
                        <div class="montant-section">
                            <label for="montant" class="montant-label">frais mensuels:</label>
                        ...
                        <form method="POST" id="myPay" action="{{ route('etudepaiement.store') }}">
                            @csrf
