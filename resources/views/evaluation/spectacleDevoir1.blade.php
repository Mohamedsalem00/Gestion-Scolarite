            ...
            <div class="container">
                <div class="row align-items-center"  id="allAction">
                    ...
                    <div class="col-md-9 text-md-start text-center">
                        <p class="mb-0"> Debut: <strong> 2023-10-09 </strong> | Fine: <strong> 2023-10-13 </strong></p>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <h1 class="text-center mt-4">Emploi du temps de la semaine des devoirs (1)</h1>
                    </div>
                </div>
            </div>
        </header>
